...
## Descripción General
Este proyecto es una aplicación web para la **Akibushido Colombia**, construida con **HTML**, **Tailwind CSS** y **Supabase** como Backend-as-a-Service (BaaS). Permite a los clubes registrarse, gestionar miembros y manejar inscripciones a torneos.
